"""Add the EMP010 local development identity.
...
_MEMBER_ID = "00000000-0000-0000-0000-000000000010"
...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            {
                "id": _MEMBER_ID,
                "username": "member.emp010",
                "normalized_username": "member.emp010",
    ...
    op.bulk_insert(
        links,
        [{"user_id": _MEMBER_ID, "member_id": "EMP010"}],
    )
