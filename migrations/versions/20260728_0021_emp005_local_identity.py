"""Add the EMP005 local development identity.
...
_MEMBER_EMP005_ID = "00000000-0000-0000-0000-000000000005"
...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            {
                "id": _MEMBER_EMP005_ID,
                "username": "member.emp005",
                "normalized_username": "member.emp005",
    ...
    op.bulk_insert(
        user_roles,
        [{"user_id": _MEMBER_EMP005_ID, "role": "MEMBER"}],
    )
    ...
    op.bulk_insert(
        member_links,
        [{"user_id": _MEMBER_EMP005_ID, "member_id": "EMP005"}],
    )
