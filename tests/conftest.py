...
def _reset_database(database_url: str, *, include_setup: bool) -> None:
    ...
    with engine.begin() as connection:
        ...
        connection.execute(
            text(
                "TRUNCATE TABLE evidence_candidates, model_extractions, "
                "ocr_observations, ocr_page_results, document_page_artifacts, "
                "identity_reconciliations, member_actions, "
                "document_triage_results, "
                "component_failures, rule_results, decision_records, casefiles, "
                "processing_fixtures, workflow_events, workflow_effects, workflow_runs, "
                "claim_actions, "
