...
async def _run_rendered_case(
    ...
    submitted = await client.post(
        ...
        headers={
            ...
            "Idempotency-Key": f"{case_id.casefold()}-rendered-gate",
        },
...
def _source_versions(raw_dataset: dict[str, Any]) -> SourceVersions:
    return SourceVersions(
        ...
        execution_profile=ExecutionProfile.RENDERED_RECORDED,
        ocr_mode="ENABLED",
    )
