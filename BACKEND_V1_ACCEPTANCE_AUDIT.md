...
| 3 | Worker loop, health, frontend contract | `tests/integration/test_document_role_gate.py`, `tests/integration/test_work_scheduler.py`, `frontend_integration.md` |
...
| 13 | Proof artifacts and quality gates | `artifacts/backend-v1/`, `BACKEND_V1_COMPLETION.md`, `uv run pytest -q` |

## Current commands and results

- Default verification: `uv run pytest -q` → **235 passed, 4 live-AWS skipped** in 102.81s.
